<%@page import="java.util.*,java.rmi.*, javax.ejb.*,javax.naming.*,factory.*,login.*,savings.*,SessionFacade.*"  %>
<%! 
...
<% 
	...
	ViewSavBean bean= (ViewSavBean)session.getAttribute("MODIFY_SAV_BEAN");
	...
	ret= remote.modifySavAccount(bean.getAccno(),bean); 
	if(ret==1){
