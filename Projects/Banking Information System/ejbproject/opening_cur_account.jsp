...
<%@ page import="java.util.*,login.*,factory.*,savings.*,SessionFacade.*,current.*" %>
<html>
<head>
...
<tr><td>
<br>
<div align=center class=brownhead>Opening Current Account</div><br>
<p>&nbsp;</p>
<form action="./opening_cur_process.jsp" method="post">
...
<tr bgcolor="#FFFFFF"> 
	...
	%>
	<font color="#FF0000"><input name="odate" type="text" id="odate"  value ="<%=d %>" readonly="">
	</font> </font></td>
</tr>
<tr bgcolor="#FFFFCC"> 
