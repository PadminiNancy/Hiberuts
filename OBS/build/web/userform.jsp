...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
						...
						<ul>
                                                             <li><a href="userform.jsp">Account Request</a></li>
...
<center/>
            ...
            <html:form action="/user2Serv">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Uname ::</font></td><td> <html:text style="height: 21px" property="uname"/> </td><td> <html:errors property="uname"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Age ::</font></td><td> <html:text style="height: 21px" property="age" /> </td><td> <html:errors  property="age"/></td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Sex::</font></td><td><html:text style="height: 21px" property="sex"/></td>
                </tr>
                  <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Add::</font></td><td><html:textarea cols="25" rows="8" property="address"/></td>
                </tr>
                  <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Mobile No::</font></td><td><html:text style="height: 21px" property="phno"/></td><td><html:errors  property="phno"/></td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
