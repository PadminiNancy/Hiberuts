	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;<center/>
                                        <html:form action="/DeleteAcctReq">
 <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="" style="color:black">
     <td>&nbsp;&nbsp;&nbsp;&nbsp;User Name</td><td>Age</td><td>Sex</td><td>Address</td><td>Phno</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="uname" value="<c:out value="${dd.uname}"/>">&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${dd.uname}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.age}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.sex}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.address}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.phno}"/></font></td>

                 <td> <a href="ModiUser2Serv.do?acno=${dd.uname}" ></a></td>
