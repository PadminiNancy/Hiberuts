...
-->
		...
		<title> Modify Stop Request!</title>
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
                ...
                <div id="sidebar" style="height:454px">
					<div class="box">
                                            <br/><br/><br/>
						<h3>Stop Cheque Request</h3>
					</div>
					<div class="box">
					</div>
				</div>
            ...
            <html:form action="/ModiStopPaymentServ">
                <tr>
                ...
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Cheque Number::</font></td><td> <html:text style="height: 21px" property="chqno"/> </td>
                </tr>
