	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height:640px"/>
				...
				<div id="content"/>
                                &nbsp;<br/>
 <font face="Bell MT" class="fsx06" color="#400000"/><b/>Online Banking Solutions has affliates under various organisations such as:<br/>
 <table cellpadding="10" cellspacing="10">
     <center/>

     <tr><td><font face="Bell MT" class="fsx06" color="#400000"/>1.&nbsp;<b/>Human Resource Development</td></tr>
     <tr> <td><font face="Bell MT" class="fsx06" color="#400000"/>2.&nbsp;<b/>Nationl Banking Federation</td></tr>
     <tr> <td><font face="Bell MT" class="fsx06" color="#400000"/>3.&nbsp;<b/>Swiss Bank,Switzerland</td></tr>
     </table>
