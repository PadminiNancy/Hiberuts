...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/NewTranServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Transaction Id::</font></td><td> <html:text style="height: 21px" property="tr_id"/> </td>
                        <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="br_err"/></font>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Transaction Date::</font></td><td> <html:text style="height: 21px" property="tr_date" /> </td>
                        <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="br1_err"/></font>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Number::</font></td><td> <html:text style="height: 21px" property="acno"/> </td>
                        <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="pass4_err"/></font>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Particulars::</font></td><td> <html:text style="height: 21px" property="parti"/> </td>
                    <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="nm_err"/></font>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Debit::</font></td><td> <html:text style="height: 21px" property="dr"/> </td>
                        <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="pass1_err"/></font>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Credit::</font></td><td> <html:text style="height: 21px" property="cr"/> </td>
                        <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="pass_err"/></font>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Action::</font></td><td> <html:text style="height: 21px" property="action"/> </td>
                        <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="pass3_err"/></font>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Reference Number::</font></td><td> <html:text style="height: 21px" property="ref_num"/> </td>
                        <font face="Bell MT" class="fsx06" color="#red"><b/><html:errors property="pass2_err"/></font>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <html:reset value="RESET"/>
                                        ...
                                        <a href="admin_home.jsp"><b/>back</a>
		<br/>
                                        <div id="footer">
