	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
          ...
          <table cellpadding="8" cellspacing="8">
                ...
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Holder Name::</font></td><td> <c:out value="$${requestScope.al}"/> </td>

                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Phone Num::</font></td><td> <c:out value="${requestScope.al.ph}"/></td>

                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Address::</font></td><td> <c:out value="${requestScope.al.adr}"/></td>

                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Date Of Birth::</font></td><td> <c:out value="${requestScope.al.dob}"/></td>

                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Identification Mark::</font></td><td><c:out value="${requestScope.al.idf}"/></td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Email Address::</font></td><td> <c:out value="${requestScope.al.email}"/></td>
