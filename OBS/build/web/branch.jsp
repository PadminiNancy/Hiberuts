...
<%@ page import="com.myapp.struts.ClBean"%>
<html:html>
	<head>
            <%
...
<center/>
            ...
            <html:form action="/NewBranchServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Branch Code ::</font></td><td> <html:text style="height: 21px" property="bcode" value="<%=cb.getBranch()%>"/> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="branch_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Location::</font></td><td> <html:text style="height: 21px" property="loc" /> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="loc_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>District::</font></td><td><html:text style="height: 21px" property="dist"/></td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="dist_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>State::</font></td><td><html:text style="height: 21px" property="state"/></td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="state_err"/>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
