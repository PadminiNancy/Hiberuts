	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height: 640px"/>
					...
					<div class="box">
						<br/><br/><br/><br/>
						<h3><font face="Bell MT" class="fsx06" color="#400000">Employee Login</font></h3>
					</div>
					<div class="box">
					</div>
				</div>
            ...
            <html:form action="/NewEmpSearchServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Employee Code::</font></td><td> <html:text style="height: 21px" property="emp_code"/> </td>
                <font face="Bell MT" class="fsx06" color="#400000"><b/><html:errors property="brn_err"/></font>
                </tr>
                
                <tr>
                    <td><b/><font face="Bell MT" class="fsx06" color="#400000">Branch Code::</font></td><td> <html:password  style="height: 21px" property="bcode"/> </td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
