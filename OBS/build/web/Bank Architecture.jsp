		...
		<div id="wrapper"/>
			<div id="header">
				<div id="logo">
					...
					<span class="slogan"><b><i>make banking easy</i></b></span>
				</div>
			</div>
			<div id="menu">
				<ul>
...
<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height:650px"/>
				<div id="sidebar" style="width: 280px">
					<div class="box">
                                             <img class="alignleft" src="images/map.JPG" width="250" height="250" alt="" />
					</div>
					<div class="box">
					</div>
				</div>
				<div id="content"/>
					<div class="box"/>
                                        <center/>
                                        <font size="4" face="Bell MT" class="fsx06" color="black"/><b/>Major Branches<br/><br/>
 <font face="Bell MT" class="fsx06" color="green">Bangalore:</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">KattamKulathur</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">Near Internationl Airport</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">Ph:8976-7630917</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">PinCode:3450079</font><br/><br/>
 
 
     <font face="Bell MT" class="fsx06" color="green">Ranchi:</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">jd Street</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">opp. church complex,main road Ranchi</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">Ph:00976-7624398</font><br/>
 <font face="Bell MT" class="fsx06" color="#400000">PinCode:843001</font>
 <div id="footer">
     
<marquee onmouseover="this.scrollAmount=0" onmouseout="this.scrollAmount=2" truespeed="0" scrollamount="2" scrolldelay="20">
	<font face="Bell MT" class="fsx06" color="red"/><b/>
