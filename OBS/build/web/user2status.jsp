		...
		<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height:640px"/>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;<center/>
						<font face="Bell MT" class="fsx06" color="#400000"><b/>Your Request Will Be Processed Soon!!<br/>And a confirmation message will be send to your registered Mobile No.</font>
                                                <br/><a href="home.jsp"><b/>back</a>
		<br/><br/><br/> <br/>
                                                <div id="footer">
