		...
		<div id="wrapper"/>
			...
			<div id="menu">
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;<center/>
                                        <html:form action="/DeleteUserServ">
 <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="" style="color:black">
     <td>&nbsp;&nbsp;&nbsp;&nbsp;User Name</td><td>Account Number</td><td>Branch</td><td>IFC Code</td>
 </tr>
	 ...
	 <tr>
		 ...
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.ifc}"/></font></td>

                 <td> <a href="ModiUserServ.do?acno=${dd.acno}" ></a></td>
