...
%>
            ...
            <html:form action="/NewEmpServ">
                ...
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Branch Code::</font></td><td> <html:text style="height: 21px" property="bcode" /> </td>

                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Employee Name ::</font></td><td> <html:text style="height: 21px" property="ename"/> </td>
