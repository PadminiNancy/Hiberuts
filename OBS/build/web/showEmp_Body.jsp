			...
			<div id="page" style="height: 640px"/>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;
                                        <center/>
<html:form action="/DeleteEmpServ">
<table width="600" cellpadding="3" cellspacing="0">
 <tr style="color:black" >
 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Emp Code</td><td>BCode</td><td>Emp Name</td>
 </tr>
	 <c:forEach var="dd" items="${requestScope.la}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="emp_code" value="<c:out value="${dd.emp_code}"/>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${dd.emp_code}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.bcode}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.ename}"/></font></td>

                 <td><a href="ModiEmpServ.do?${dd.emp_code}"> </a></td>
