...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/NewDraftServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Number::</font></td><td> <html:text style="height: 21px" property="acno"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Request Id::</font></td><td> <html:text style="height: 21px" property="req_id" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Request Date::</font></td><td> <html:text style="height: 21px" property="req_date"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Cheque No::</font></td><td> <html:text style="height: 21px" property="cheque_no"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Uname::</font></td><td> <html:text style="height: 21px" property="uname"/> </td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
