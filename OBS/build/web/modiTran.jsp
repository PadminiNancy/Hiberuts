...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/ModiTranServ">
                 <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Trans Id ::</font></td><td> <html:text property="tr_id" value="${requestScope.ac.acno}"/> </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">DR ::</font></td><td> <html:text property="dr" value="${requestScope.ac.act_type}" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">CR::</font></td><td> <html:text property="cr" value="${requestScope.ac.dop}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">PARTI ::</font></td><td> <html:text property="parti" value="${requestScope.ac.uname}"/> </td>
                    ...
                    <td>
                        ...
                        <html:reset value="RESET"/>
                                        ...
                                        <a href="admin_home.jsp"><b/>back</a><br/>
<br/>
                                        <div id="footer">
