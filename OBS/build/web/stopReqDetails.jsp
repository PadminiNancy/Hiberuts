...
-->
		...
		<title>Stop Request Details!</title>
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
                ...
                <div id="sidebar" style="height:422px">
					<div class="box">
                                            <br/><br/><br/>
						<h3>Stop Payment List</h3>
					</div>
					<div class="box">
									</div>
				</div>
				<div id="content"/>
					<div class="box"/>
                                        <html:form action="/DelStopPayReqServ">
                                        <center/>
 <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="" style="color:black">
     <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Req ID</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Req Date</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acc No.</td><td>Chq No.&nbsp;&nbsp;</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.la}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="sreq_id" value="<c:out value="${dd.sreq_id}"/>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${dd.sreq_id}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.sreq_date}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.acno}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.chqno}"/></font></td>
