...
-->
 ...
 <td>Acc No</td><td>Req_Id</td><td>Req_Date</td><td>Uname</td>
 </tr>
	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.acno}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.req_id}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.req_date}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.uname}"/></font></td>
                   ...
                   <td><a href="DeleteEmpServ.do?$${dd.req_id}"></a></td>
         </tr>
	 </c:forEach>
 <tr bgcolor="white">
 <td colspan="4">&nbsp;</td>
