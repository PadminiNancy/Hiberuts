...
-->
 ...
 <tr bgcolor="" style="color:black">
     <td>Tr_Id</td><td>Tr_Amt</td><td>To Acno</td><td>Verif_By</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.treq_id}"/></font></td>
		 ...
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.toacno}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.verified_by}"/></font></td>
