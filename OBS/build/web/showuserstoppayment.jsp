...
-->
		...
		<title>Stop Payment Requests!</title>
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height: 640px"/>
					...
					<div class="box">
                                            <br/><br/><br/>
						<h3>Stop Chq Payment Requests</h3>
					</div>
					<div class="box">
					</div>
				</div>
 ...
 <td>SReq_Id</td><td>SReq_Date</td><td>Acno</td><td>Chqno</td>
 </tr>
	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.sreq_id}"/></font></td>
