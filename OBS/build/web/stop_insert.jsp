...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
                ...
                <div id="page" style="height:700px"/>
                <div id="sidebar" style="height:493px">
					<div class="box">
                                            <br/><br/><br/>
						<h3>Stop Cheque Payment Request</h3>
					</div>
					<div class="box">
					</div>
				</div>
            ...
            <html:form action="/NewStopServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Stop Request Id ::</font></td><td> <html:text style="height: 21px" property="sreq_id"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Stop Request Date ::</font></td><td> <html:text style="height: 21px" property="sreq_date" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Number::</font></td><td> <html:text style="height: 21px" property="acno"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Cheque Number::</font></td><td> <html:text style="height: 21px" property="chqno"/></td><td><html:errors property="chqno"/></td>
                </tr>
