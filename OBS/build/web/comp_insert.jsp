...
<center/>
            ...
            <html:form action="/NewCompServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Complain Id ::</font></td><td> <html:text style="height: 21px" property="cid"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Complain Date ::</font></td><td> <html:text style="height: 21px" property="cdate" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Complain text::</font></td><td><html:textarea cols="25" rows="8" property="ctext"/></td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
