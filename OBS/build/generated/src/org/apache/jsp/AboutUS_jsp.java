...
public final class AboutUS_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\n");
      out.write("                                                \n");
      out.write(" <font face=\"Bell MT\" class=\"fsx06\" color=\"#400000\"><b/>The Bank is actively involved since 1973 in non-profit activity called Community Services Banking. All our branches and administrative offices throughout the country sponsor and participate in large number of welfare activities and social causes. Our business is more than banking because we touch the lives of people anywhere in many ways.<br/>\n");
      out.write(" Our commitment to nation-building is complete &amp; comprehensive.<br/>OBS has always been fundamentally strong in its core business which is mirrored in its results ,year after year.\n");
      out.write(" </font>\n");
      out.write("<br/><br/><br/>\n");
