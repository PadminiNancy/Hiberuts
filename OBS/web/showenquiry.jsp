			...
			<div id="page" style="height: 640px"/>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;
                                        <center/>
                                        <html:form action="/DeleteEnquiryServ">
						<table width="600" cellpadding="3" cellspacing="0">
 <tr style="color:black" >
 <td>&nbsp;&nbsp;&nbsp;&nbsp;From</td><td>Subject</td><td>Enquiry</td><td>Email</td>
 </tr>
	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="from1" value="<c:out value="${dd.from1}"/>">&nbsp;&nbsp;<c:out value="${dd.from1}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.subject}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.enquiry}"/></font></td>
