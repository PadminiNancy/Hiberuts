...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/NewFundServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Transaction Id ::</font></td><td> <html:text style="height: 21px" property="treq_id"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Transaction Date ::</font></td><td> <html:text style="height: 21px" property="treq_date" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Number::</font></td><td> <html:text style="height: 21px" property="acno"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Transfer Amount::</font></td><td> <html:text style="height: 21px" property="trf_amt"/> </td>
                </tr>
                 <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>To Account Number::</font></td><td><html:text style="height: 21px" property="toacno"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Bank name::</font></td><td> <html:text style="height: 21px" property="bank" /> </td>
                </tr>
                <tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Verified By::</font></td><td> <html:text style="height: 21px" property="verified_by"/> </td>
                </tr>
