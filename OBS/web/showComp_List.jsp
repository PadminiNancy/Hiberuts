	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
				...
				<div id="content"/>
					<div class="box"/>
	                                        &nbsp;
                                                <html:form action="/DeleteComplaintServ">
                                        <center/>
 <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="white" style="color:black">
     <td>&nbsp;&nbsp;&nbsp;Comp_Id</td><td>Complaint Date</td><td>Complaint</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="cid" value="<c:out value="${dd.cid}"/>">&nbsp;&nbsp;&nbsp;<c:out value="${dd.cid}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.cdate}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.ctext}"/></font></td>
