...
-->
	...
	<body>
        ...
        <html:form action="/NewHolderServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Holder Name::</font></td><td> <html:text style="height: 21px" property="hname"/> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="hname_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Phone Num::</font></td><td> <html:text style="height: 21px" property="ph" /> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="ph_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Address::</font></td><td> <html:text style="height: 21px" property="adr"/> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="adr_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Date Of Birth::</font></td><td> <html:text style="height: 21px" property="dob"/> </td>
                    <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="dob_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Identification Mark::</font></td><td> <html:text style="height: 21px" property="idf"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Email Address::</font></td><td> <html:text style="height: 21px"  property="email"/> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="email_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Number::</font></td><td> <html:text style="height: 21px" property="acno" value="${sessionScope.acno}"/> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="holder_err"/>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
                        ...
                        <html:reset value="RESET"/>
                                        ...
                                        <a href="newac_body.jsp"><b/>back</a>
                                        <br/>
		<div id="footer">
