...
<center/>
            ...
            <html:form action="/FeedServ">
                ...
                %>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>FeedBack Id ::</font></td><td> <html:text   style="height: 21px" property="fid"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>FeedBack Date ::</font></td><td> <html:text style="height: 21px" property="fdate" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>FeedBack::</font></td><td><html:textarea cols="25" rows="8" property="ftext"/></td><td><html:errors property="ftext"/></td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
