		...
		<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height:640px"/>
				...
				<div id="content"/>
                                &nbsp;
                                <center/>
                                <font face="Bell MT" class="fsx06" color="#400000"/><b/>Send your account request by filling the form under 'New User'.<br/>You must provide all the requisite details.Your request will be registered and will be processed soon.After creating the account, a confirmation message will be sent to your registered email-id.Your account will be activated only after you reply to the sent message.<br/><font face="Bell MT" class="fsx06" color="black"/>You have to confirm message within 15 days.<br/><font face="Bell MT" style="font-decoration:blink" class="fsx06" color="#400000"/>After confirmation your branchcode will be sent to you.<br/>Enjoy banking with the no. 1 bank of the world
 <br/><br/><a href="userform.jsp"><font face="Bell MT" class="fsx06" color="green"/><b/>Account Request</a>
<br/><br/>
						<div id="footer">
	<marquee onmouseover="this.scrollAmount=0" onmouseout="this.scrollAmount=2" truespeed="0" scrollamount="2" scrolldelay="20">
		<font face="Bell MT" class="fsx06" color="red"/>
