...
-->
		...
		<title>Modify Cheque Request!</title>
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/ModiChqServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Number::</font></td><td> <html:text style="height: 21px" property="acno" value="${requestScope.al.acno}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Request Id::</font></td><td> <html:text style="height: 21px" property="req_id" value="${requestScope.al.req_id}" /> </td>
                </tr>
