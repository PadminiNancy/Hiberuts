	...
	<body>
		<div id="wrapper"/>
            ...
            <html:form action="/NewUserServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>User Name ::</font></td><td> <html:text style="height: 21px" property="uname"/> </td>
                ...
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Ifc_Code::</font></td><td> <html:text style="height: 21px" property="ifc"/> </td>
