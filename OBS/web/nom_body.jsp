...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/NewNomServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Nominee Name::</font></td><td> <html:text style="height: 21px" property="nom_name"/> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="nomi_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Date Of Birth::</font></td><td> <html:text style="height: 21px" property="dob" /> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="dobn_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Relation::</font></td><td> <html:text style="height: 21px" property="rel"/> </td>
                        <font face="Bell MT" class="fsx06" color="red"/><b/><html:errors property="rel_err"/>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <html:reset value="RESET"/>
                                        ...
                                        <a href="holder_body.jsp"><b/>back</a>
		<br/><br/><br/> <br/>
                                        <div id="footer">
