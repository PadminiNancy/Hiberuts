			...
			<li><a href="AboutUS.jsp">About Us</a></li>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;
                                        <center/>
                                        <html:form action="/DelAccountServ">
                                        <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="white" style="color:black">
     <td>&nbsp;&nbsp;&nbsp;&nbsp;Uname</td><td>Acct No</td><td>Acct_Type</td><td>Brch Code</td><td>Bal</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.la}">
	 <tr>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="acno" value="<c:out value="${dd.acno}"/>">&nbsp;&nbsp;<c:out value="${dd.uname}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.acno}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.act_type}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.branch}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.bal}"/></font></td>
                 <td> <a href="DetailAcc.do?acno=${dd.acno}" >Detail</a></td>
                 <td> <a href="ModiAcServ.do?acno=${dd.acno}" ></a></td>
