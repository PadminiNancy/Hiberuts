	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;<center/>
                                        <html:form action="/DeleteLoanServ">
                                        <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="" style="color:black">
     <td>&nbsp;&nbsp;&nbsp;&nbsp;Fname</td><td>Age</td><td>&nbsp;&nbsp;Loan_Type</td><td>Garranter</td><td>Email</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="fname" value="<c:out value="${dd.fname}"/>">&nbsp;&nbsp;<c:out value="${dd.fname}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.age}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000">&nbsp;&nbsp;<c:out value="${dd.loan_type}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.grant}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.email}"/></font></td>
