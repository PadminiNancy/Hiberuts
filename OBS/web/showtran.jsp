...
-->
 ...
 <html:form action="/DeletetranServ">
 <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="" style="color:black">
 <td>&nbsp;&nbsp;&nbsp;Tr_Id</td><td>&nbsp;&nbsp;&nbsp;Tr_Date</td><td>Accno</td>
 </tr>
	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
             <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="tr_id" value="<c:out value="${dd.tr_id}"/>">&nbsp;&nbsp;<c:out value="${dd.tr_id}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.tr_date}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.acno}"/></font></td>

                 <td><a href="ModiTranServ.do?${dd.tr_id}"> </a></td>
