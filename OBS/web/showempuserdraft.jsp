			...
			<div id="page" style="height: 640px"/>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;
                                        <center/>
                                        <html:form action="/DeleteDraftReq">
                                        <table width="600" cellpadding="3" cellspacing="0">
 <tr style="color:black" >
 <td>&nbsp;&nbsp;&nbsp;Req_Id</td><td>Acc No</td><td>cheque_no</td><td>Uname</td>
 </tr>
	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		<td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="req_id" value="<c:out value="${dd.req_id}"/>">&nbsp;&nbsp;<c:out value="${dd.req_id}"/></font></td>
                <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.acno}"/></font></td>
		<td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.cheque_no}"/></font></td>
                <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.uname}"/></font></td>

                 <td><a href="ModiEmpServ.do?${dd.acno}"></a></td>
