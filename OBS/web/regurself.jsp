...
-->
	...
	<body>
        ...
        <table align="Center" cellpadding="8" cellspacing="8">
            <html:form action="/RegUrSelfServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Number ::</font></td><td> <html:text style="height: 21px" property="acno"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Old Password ::</font></td><td> <html:password style="height: 21px" property="pass" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>New password ::</font></td><td> <html:password style="height: 21px" property="np" /> </td>
                </tr>
                <tr>
