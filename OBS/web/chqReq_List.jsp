		...
		<div id="wrapper"/>
			...
			<div id="page" style="height:640px"/>
				...
				<div id="content"/>
                                            ...
                                            &nbsp;
                                            <center/>
                                            <html:form action="/DelChqReqServ">
 <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="" style="color:black">
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Uname</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Account Number</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Request Date</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="req_id" value="<c:out value="${dd.req_id}"/>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${dd.uname}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.acno}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.req_date}"/></font></td>

                 <td> <a href="ModiChqServ.do?acno=${dd.req_id}" ></a></td>
