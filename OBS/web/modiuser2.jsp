...
<center/>
            ...
            <html:form action="/ModiUser2Serv">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Uname ::</font></td><td> <html:text style="height: 21px" property="uname" value="${requestScope.ac.acno}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Age ::</font></td><td> <html:text style="height: 21px" property="age" value="${requestScope.ac.age}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Sex::</font></td><td><html:text style="height: 21px" property="sex" value="${requestScope.ac.sex}"/></td>
                </tr>
                  <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Add::</font></td><td><html:textarea cols="25" rows="8" property="add" value="${requestScope.ac.add}"/></td>
                </tr>
                  <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Ph No::</font></td><td><html:text style="height: 21px" property="phno" value="${requestScope.ac.phno}"/></td>
                </tr>
                 <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Email::</font></td><td><html:text style="height: 21px" property="email" value="${requestScope.ac.email}"/></td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
