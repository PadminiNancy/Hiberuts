...
<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/NewUserServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>User Name ::</font></td><td> <html:text style="height: 21px" property="uname"/> </td><td><html:errors property="uname"/></td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Acc No::</font></td><td> <html:text style="height: 21px" property="acno" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Branch ::</font></td><td> <html:text style="height: 21px" property="branch"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Ifsc_Code::</font></td><td> <html:password style="height: 21px" property="ifc"/> </td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
