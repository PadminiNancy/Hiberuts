...
<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height: 550px"/>
                        <div id="sidebar" style="height: 357px">
					<div class="box">
                                            <br/><br/><br/><br/>
						<h3><font face="Bell MT" class="fsx06" color="black"><b/>Admin Login</font></h3>
					</div>
					<div class="box">
						<div class="date-list">
            ...
            <html:form action="/NewAdminSearchServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Admin Code::</font></td><td> <html:text style="height: 21px" property="admin_code"/> </td>
                <font face="Bell MT" class="fsx06" color="green"/><b/><html:errors property="brn_err"/>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">PassWord::</font></td><td> <html:password style="height: 21px" property="pass"/> </td>
                </tr>
                <tr>
                    <td>
                        &nbsp; 
