		...
		<div id="wrapper"/>
			...
			<div id="page" style="height:640px"/>
				...
				<div id="content"/>
                                <center/>
                                &nbsp;
 <img class="alignleft" src="images/prem.jpg" width="230" height="260" alt="" />
 <br/><br/><br/>
 <font face="Bell MT" class="fsx06" color="black"><b>PREMCHAND HANSDA</b>
                                            <h6> NATIONAL INSTITUTE OF TECHNOLOGY RAIPUR,CHHATTISGARH,INDIA</h6>
                                             <h6>Email:premh13@gmail.com</h6>
                                             <h6>Contact No:9534959792</h6>
                                               <br/><br/> <br/><br/> <br/><br/>
<div id="footer">
