...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/ModiUserServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Uname ::</font></td><td> <html:text property="uname" value="${requestScope.ab.uname}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Account ::</font></td><td> <html:text property="acno" value="${requestScope.ab.act_type}" /> </td>
                </tr>
                
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Branch ::</font></td><td> <html:text property="branch" value="${requestScope.ab.branch}"/> </td>
                    <html:errors property="br_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">IFC Code ::</font></td><td> <html:text property="ifc_code" value="${requestScope.ab.ifc_code}"/> </td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
