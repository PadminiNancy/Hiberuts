...
-->
 ...
 <td>Uname</td><td>&nbsp;Acc No</td><td>Acc _type</td><td>Pass</td><td>Bal</td><td>Branch</td>
 </tr>
	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.uname}"/></font></td>
		 ...
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.act_type}"/></font></td>
                 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.pass}"/></font></td>
                 ...
                 <td><a href="ModiEmpServ.do?${dd.uname}">M</a></td>
         </tr>
	 </c:forEach>
 <tr bgcolor="white">
 <td colspan="4">&nbsp;</td>
