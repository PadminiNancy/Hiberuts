...
-->
	...
	<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height: 640px"/>
                        <div id="sidebar" style="height: 385px">
					<div class="box">
                                            <br/><br/><br/><br/>
						<h3>User Login</h3>
					</div>
            ...
            <html:form action="/UserLoginServ">
                <tr>
                    <td><b/><font face="Bell MT" class="fsx06" color="#400000">User Name::</font></td><td> <html:text style="height: 21px" property="uname"/> </td>
                      <font face="Bell MT" class="fsx06" color="green"><b/><html:errors property="brn_err"/></font>
                </tr>

                <tr>
                    <td><b/><font face="Bell MT" class="fsx06" color="#400000">Branch::</font></td><td> <html:password style="height: 21px" property="branch"/> </td>
                </tr>
                <tr>
                    <td>
                        &nbsp;
