...
-->
	...
	<body>
			...
			<div id="header">
				<div id="logo">
					<h1><a href="#">Online Banking And Management System</a></h1>
...
<li><a href="AboutUS.jsp">About Us</a></li>
									...
									<li><a href="enquiry.jsp">Enquiry</a></li>
                                                                        ...
                                                                        <li><a href="AboutMe.jsp">About ME</a></li>								</ul>
							</li>
                                                        						</ul>
                                                <li class="first">
			...
			<div id="page" style="height: 640px"/>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;
<center/>
     <a href="new_emp.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Creats New Employee</font></a>
<br/>
     <a href="listEmp.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Current Employees List</font></a>
<br/>
     <a href="tran_insert.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Do Transaction</font></a>
<br/>
     <a href="list_tran.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Transaction Details</font></a>
<br/>
     <a href="list_user.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Active Users</font></a>
<br/>
     <a href="list_comp.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Complain List</font></a>
<br/>
     <a href="listfeed.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>FeedBacks</font></a>
<br/>
