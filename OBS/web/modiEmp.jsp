...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/ModiEmpServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Employee Code ::</font></td><td> <html:text property="emp_code" value="${requestScope.ac.emp_code}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Branch Code ::  </font></td><td> <html:text property="bcode" value="${requestScope.ac.bcode}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Employee Name ::</font></td><td> <html:text property="ename" value="${requestScope.ac.ename}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">PassWord ::     </font></td><td> <html:text property="pass" value="${requestScope.ac.pass}"/> </td>
