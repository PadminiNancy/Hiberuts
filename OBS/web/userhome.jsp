...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
			...
			<div id="page" style="height:790px"/>
                        <div id="sidebar" style="height: 607px">
                                    <div class="box">
                                            <br/><br/><br/><br/>
                                                               <h3>Welcome::${sessionScope.un}</h3>
											</div>
					<div class="box">							
					</div>
				</div>
                             ...
                             <center/>
        <br/>
        <a href="listuseracctdetails.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Account Details</font></a>
        <br/>
        <a href="chq_insert.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Cheque Book Request</font></a>
        <br/>
        <a href="listchquser.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Cheque Book Request Details</font></a>
        <br/>
        <a href="fund_insert.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Fund Transfer</font></a>
        <br/>
        <a href="tran_details.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Fund Transfered Details</font></a>
        <br/>
        <a href="stop_insert.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Stop Cheque Payment</font></a>
        <br/>
        <a href="listuserstoppayment.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Stop Cheque Payment Details</font></a>
        <br/>
        <a href="draft_insert.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Draft Request</font></a>
        <br/>
        <a href="listuserdraftdetails.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Draft Request Details</font></a>
        <br/>
        <a href="comp_insert.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Register Complain</font></a>
        <br/>
        <a href="regurself.jsp"><font face="Bell MT" class="fsx06" color="#400000"><b/>Update YourSelf</font></a>
        <br/>
