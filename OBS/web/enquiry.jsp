	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
				...
				<div id="sidebar">
					<div class="box">
<br/><br/><br/>
<img class="alignleft" src="images/enq.gif" width="88" height="91" alt="" />
...
<center/>
            ...
            <html:form action="/NewEnqServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>From::</font></td><td> <html:text style="height: 21px" property="from1"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Subject::</font></td><td> <html:text style="height: 21px" property="subject" /> </td>
                </tr>
                  <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000"><b/>Enquiry::</font></td><td><html:textarea cols="25" rows="8" property="enquiry"/></td>
                </tr>
                <tr>
