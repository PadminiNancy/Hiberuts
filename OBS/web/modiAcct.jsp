...
-->
	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
            ...
            <html:form action="/ModiAcServ">
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Account Number ::</font></td><td> <html:text property="acno" value="${requestScope.ac.acno}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Account Type ::</font></td><td> <html:text property="act_type" value="${requestScope.ac.act_type}" /> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Date Of Opening ::</font></td><td> <html:text property="dop" value="${requestScope.ac.dop}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">User Name ::</font></td><td> <html:text property="uname" value="${requestScope.ac.uname}"/> </td>
                    <html:errors property="nm_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">PassWord ::</font></td><td> <html:password property="pass" value="${requestScope.ac.pass}"/> </td>
                    <html:errors property="pass_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Balance ::</font></td><td> <html:text property="bal" value="${requestScope.ac.bal}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Balance Type ::</font></td><td> <html:text property="bal_type" value="${requestScope.ac.bal_type}"/> </td>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">Branch ::</font></td><td> <html:text property="branch" value="${requestScope.ac.branch}"/> </td>
                    <html:errors property="br_err"/>
                </tr>
                <tr>
                    <td><font face="Bell MT" class="fsx06" color="#400000">IFC Code ::</font></td><td> <html:text property="ifc_code" value="${requestScope.ac.ifc_code}"/> </td>
                </tr>
                <tr>
                    <td>
                        &nbsp; &nbsp;
