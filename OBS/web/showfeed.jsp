	...
	<body>
		...
		<li><a href="AboutUS.jsp">About Us</a></li>
				...
				<div id="content"/>
					<div class="box"/>
                                        &nbsp;<center/>
                                        <html:form action="/DelFeedServ">
 <table width="600" cellpadding="3" cellspacing="0">
 <tr bgcolor="" style="color:black">
     <td>&nbsp;&nbsp;&nbsp;&nbsp;FeedBack ID</td><td>FeedBack Date</td><td>FeedBack</td>
 </tr>

	 <c:forEach var="dd" items="${requestScope.al}">
	 <tr>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><input type="checkbox"  name="fid" value="<c:out value="${dd.fid}"/>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${dd.fid}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.fdate}"/></font></td>
		 <td><font face="Bell MT" class="fsx06" color="#400000"><c:out value="${dd.ftext}"/></font></td>
